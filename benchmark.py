...
# todo: vliv poctu updatovanych zarizeni v siti na celkovy cas konvergence ( possibly multiple various topologies )
...
def multi_grid_radial_size_vs_time():
    ...
    make_graph("Grid Size and Convergence Time",
               ...
               "Convergence Time", "multi_grid_radial_size_vs_timerrun10_upto_5_Bdevs32fwsize-request100.pdf", True)
...
def multi_grid_radial_size_vs_time_single_component():
    ...
    make_graph("Grid Size and Convergence Time",
               [(f"Type B Modules: {err}", [num_devs for num_devs, stats_err in stats[0][1]], [avg([y.runtime for y in stats_y]) for grid_y, stats_y in stats_err]) for err, stats_err in stats], "Total Number of Modules",
               "Convergence Time", "multi_grid_radial_size_vs_timerrun10_Bdevs32fwsize-request50-touching-wmarkers-ann1000.pdf", True)
...
grid_radial_size_vs_time_vs_seed_position()  # have, initial picture - sublinear
# grid_radial_size_vs_time_vs_err()  # ~16GiB RAM ; ~28min -- pdf, have, bumpy figure
# radial_fwsize_vs_time_vs_radius()  # have, firmware figure
# radial_grid_msg_overhead_vs_err()  # have for r3, r4, r5, r6 behaves weird
# ellipse_eccentricity()  # have with setting progress_timeout to 1000 instead of 100 since networks have huge diameter
# barbell_path_length_vs_time_vs_err()  # done use with 32 postfix
# multi_grid_radial_size_vs_time()  # still investigating
# multi_grid_radial_size_vs_time_single_component()  # seemst to work when 1000 used rerequest


# grid_long_size_vs_time_vs_err()
# grid_long_size_vs_time_vs_grid_x()
# grid_radial_size_vs_time()  # have, sublinear figure , wont use, vs seed position instead

# radial_grid_msg_overhead_vs_err_real()  # have radial_overhead-realerr - nic moc, needs changing order of dataplots


# todo: how well the protocol scales when there are ongoing updates of multiple firmwares at the same time
# todo: max queue size
# todo: ratio of two different devices types in a network - ratio between devices being upgraded and proxy devices
